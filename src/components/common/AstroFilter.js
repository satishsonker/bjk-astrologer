...
export default function AstroFilter({ showFilter }) {
                ...
                <div className='filter-container'>
                    ...
                    <div className="d-flex flex-row-reverse bd-highlight">
                        <div className="p-2 bd-highlight">
                            <button className='btn btn-sm btn-danger' onClick={e => handleCloseFilter()} >Cancel</button>
                        </div>
                        <div className="p-2 bd-highlight"><button className='btn btn-sm btn-primary'>Apply</button></div>
                        <div className="p-2 bd-highlight"><button className='btn btn-sm btn-secondary'>Clear Filter</button></div>
                    </div>
                </div>
                </div>               
            </>
