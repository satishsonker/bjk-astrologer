...
export default function ConfirmationBox({options}) {
        ...
        options.handler=common.defaultIfEmpty(options.deleteHandler,()=>{});
                        ...
                        <div className="modal-dialog">
                            <div className="modal-content">
                                ...
                                <div className="modal-footer">
                                    <button type="button"  className="btn btn-danger" onClick={e => options.handler(options.data)} data-bs-dismiss="modal">{options.actionButtonText}</button>
